...
class ProjectGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("majimenatestapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Project entity")
        ...
        .formParam("client_id", "majimenatestapp")
        ...
        .repeat(2) {
            ...
            .put("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "owner":null}""")).asJSON
            .check(status.is(201))
